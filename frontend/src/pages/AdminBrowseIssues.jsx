        ...
        try {
            ...
            if (issueIds.length > 0) {
                try {
                    ...
                    // Ignore: Failed to fetch user votes on load
                }
            }
            ...
            <div className="dashboard-container">
                ...
                <div className="dashboard-hero">
                    ...
                    <div className="hero-content-wrapper">
                        <div className="hero-badge">Admin Community View</div>
                        <h1>Browse All Community Issues</h1>
                        <p>View, filter, and manage all civic complaints reported by citizens.</p>
                ...
                <div className="browse-issues-main">
                    <div className="browse-sidebar">
                        ...
                        <div className="sidebar-panel">
                            ...
                            <p className="panel-subtitle">Filter reports by issue type</p>
                            ...
                            <div className="panel-header-main">
                                <div className="panel-title">
                                    ...
                                    <div>
                                        ...
                                        <p>Find and manage complaints</p>
                                    </div>
                                </div>
                                {
                            ...
                            <div className="panel-header-main">
                                <div className="panel-title">
                                    ...
                                    <div>
                                        ...
                                        <p>Recent reports from citizens</p>
                                    </div>
                                </div>
...
export default AdminBrowseIssues;