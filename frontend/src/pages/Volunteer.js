// Volunteer.js - Updated with Home button and Profile navigation
...
import { 
  ...
  BarChart3, Info, Home // ADDED: Home icon
} from 'lucide-react';
...
const Volunteer = () => {
  ...
  const tools = [
    ...
    },
    {
      ...
      color: 'tool-green',
      path: '/volunteer-browser-issues' // FIXED: Changed from browser to browse
    }
  ];
    ...
    <div className="volunteer-dashboard">
        ...
        <div className="header-container">
          <div className="logo-section">
            <div className="logo-box">
              <img src="/images/logo.png" alt="Clean Street" className="logo-img" />
            </div>
            <div className="logo-details">
              <h1 className="logo-title">Clean Street</h1>
              <p className="logo-subtitle">Civic Platform</p>
            </div>
          </div>
          ...
          <nav className="nav-tabs">
            ...
            <button 
              className="nav-tab" 
              onClick={() => navigate('/', { state: { userType: 'volunteer' } })}
            >
            ...
            <button 
              className="nav-tab" 
              onClick={() => navigate('/MyAssignedIssues', { state: { userType: 'volunteer' } })}
            >
            ...
            <button 
              className="nav-tab" 
              onClick={() => navigate('/volunteer-browser-issues', { state: { userType: 'volunteer' } })}
            >
          ...
          {/* UPDATED: Made user profile clickable */}
          <div className="user-profile" onClick={() => navigate('/volunteer-profile')}>
            <div className="user-avatar">{getUserInitials(user?.name)}</div>
            <div className="user-info">
              <span className="user-name">{user?.name || 'Sarah Wilson'}</span>
              <span className="user-badge">(volunteer)</span>
            </div>
      ...
      <section className="hero-section">
        <div className="hero-content">
          <h1 className="hero-title">Welcome back, {user?.name || 'Sarah Wilson'}!</h1>
